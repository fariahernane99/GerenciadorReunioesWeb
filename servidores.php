                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="cadastrarServidor">
                                    ...
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-key fa-3x" title=""></i></span><label>Siape do Servidor *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="number" placeholder="Siape do Servidor">
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-bold fa-3x" title=""></i></span><label>Nome do Servidor *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="text" placeholder="Nome do Servidor">
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-at fa-3x" title=""></i></span><label>E-mail do Servidor *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="email" placeholder="E-mail do Servidor">
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-unlock-alt fa-3x" title=""></i></span><label>Senha do Servidor *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="password" placeholder="Senha do Servidor">
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-bookmark-o fa-3x" title=""></i></span><label>Área do Servidor *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="text" placeholder="Área do Servidor">
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-phone fa-3x" title=""></i></span><label>Telefone do Servidor *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="telephone" placeholder="Telefone do Servidor">
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-plus fa-3x" title=""></i></span><label>Função do Servidor *</label>
                                    <br>
                                    <label class="radio-inline"><input type="radio" name="optradio" value="1" checked="checked">Servidor Comum</label>
                                    <label class="radio-inline"><input type="radio" name="optradio" value="2" >Coordenador</label>
                                    <label class="radio-inline"><input type="radio" name="optradio" value="3">Diretor de Ensino</label>
                                    <br><br><br><br>
