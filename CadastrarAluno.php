			...
			<section class="content-header">
				<div>
					<ul class="nav nav-tabs">
						<li role="presentation" class="active" ><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Cadastrar Aluno</a></li>
						<li role="presentation"><a href="#servidores" aria-controls="profile" role="tab" data-toggle="tab">Alunos Cadastradas</a></li>
					...
					<div class="tab-content">
						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="home">
								...
								<input type="date" class="campodetexto" placeholder="   Nome do aluno">
								<br>
