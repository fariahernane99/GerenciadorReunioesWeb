      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="CadastrarAluno.php"><i class="fa fa-user"></i> Aluno</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="Reuniao.php"><i class="fa fa-plus"></i> Cadastrar Reunião</a></li>
            <li><a href="ReunioesAgendadas.php"><i class="fa fa-search"></i> Reuniões agendadas</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
