                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="cadastrarAluno">
                                    ...
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-key fa-3x" title=""></i></span><label for="">Matrícula do Aluno *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="number" placeholder="Matrícula do Aluno ">
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-bold fa-3x" title=""></i></span><label for="">Nome do Aluno *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="text" placeholder="Nome do Aluno">
                                    <br>
                                    <span class="ccform-addon"><i class="fa fa-at fa-3x" title=""></i></span><label for="">Email do Aluno *</label>
                                    <input style="width:50%; border-radius: 6px;" class="form-control" type="email" placeholder="E-mail do Aluno">
                                    <br><br><br><br>
