			...
			<section class="content-header">
				<div>
					<ul class="nav nav-tabs">
						<li role="presentation" class="active" ><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Cadastrar Servidor</a></li>
						<li role="presentation"><a href="#servidores" aria-controls="profile" role="tab" data-toggle="tab">Servidores Cadastrados</a></li>
					...
					<div class="tab-content">
						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="home">
								...
								<br>
								<span class="ccform-addon"><i class="fa fa-google fa-3x" title=""></i></span><label for="">Email do Servidor *</label>
								<input type="E-mail" class="campodetexto" name="ser_email" placeholder="   Email do Servidor">
								<br>
							...
							<div role="tabpanel" class="tab-pane" id="servidores">
								<table border="1" class="table table-striped">
									...
									<thead>
										<tr>
										<th style="width: 15%;"><center>SIAPE</center></th>
											<th><center>Nome do Servidor</center></th>
